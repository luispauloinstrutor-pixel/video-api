...
function buildAcheiStoryFilter(data) {
  ...
  if (discountNum) {
    draws.push(
      `drawtext=text='${discountNum}':fontcolor=black:fontsize=92:x=96:y=1182:expansion=none`,
      `drawtext=text='%':fontcolor=black:fontsize=40:x=218:y=1194:expansion=none`,
      `drawtext=text='OFF':fontcolor=black:fontsize=26:x=218:y=1240:expansion=none`
    );
  }
  ...
  if (priceNumber) {
    draws.push(
      `drawtext=text='POR':fontcolor=white:fontsize=45:x=386:y=1336:expansion=none`,
      `drawtext=text='R$':fontcolor=white:fontsize=62:x=386:y=1395:expansion=none`,
      `drawtext=text='${priceNumber}':fontcolor=white:fontsize=${priceFontSize}:x=590:y=1345:expansion=none`
    );
  }

  draws.push(
    `drawtext=text='COMENTA O Nº':fontcolor=black:fontsize=44:x=255:y=1540:expansion=none`,
    `drawtext=text='${idNumber}':fontcolor=0xFF0000:fontsize=84:x=688+(150-text_w)/2:y=1527:expansion=none`,
